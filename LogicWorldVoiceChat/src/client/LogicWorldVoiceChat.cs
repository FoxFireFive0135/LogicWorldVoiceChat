...
namespace FoxFireFive_LogicWorldVoiceChat.Client
{
    public class LogicWorldVoiceChat : ClientMod
    {
        ...
        private static bool gui_initialized;
        private static LWVC_Microphone mic;
        private static bool? server_has_lwvc;
        ...
        {
            server_has_lwvc ??= PacketManager.TryGetCodeFromType(typeof(LWVC_MicrophoneData), out var _);
            return server_has_lwvc.Value;
        }
